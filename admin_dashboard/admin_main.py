...
def show_medical_records_verification():
    st.subheader("Medical Records Verification for Donors & Surrogates")
                ...
                for doctor in doctors:
                    with st.container():
                        ...
                        with col1:
                            ...
                            st.write(f"**Type:** {doctor.get('user_type', 'N/A')}")
